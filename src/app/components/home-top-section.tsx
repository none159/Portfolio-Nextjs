    ...
    <section id='tophome'  className="relative top-10 flex justify-between w-[90%] m-10 items-center align-middle">
      <div className="grid gap-10">
        ...
        <div className="flex gap-10">
          ...
          <a href='none159.github.io/public/newcv.pdf' className="bg-blue-600 px-[10px] py-[10px] rounded-md duration-[300ms] ease-in-out hover:bg-white hover:text-blue-600">
            Download CV
          </a>
        </div>
      </div>
